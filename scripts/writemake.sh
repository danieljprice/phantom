...
echo
echo '.PHONY: phantom phantomsetup phantom2power phantom2grid phantomanalysis phantomevcompare libphantom mflow ev2mdot ev2mdotsink ev2mdotbinary'
echo 'phantom         : again'
...
echo 'ev2mdotsink     : ev2mdotsink'
echo 'ev2mdotbinary   : ev2mdotbinary'
echo
echo 'clean:'
...
echo 'mflow:'
echo '	cd ${PHANTOMDIR}; make '$makeflags' mflow; cd -; cp ${PHANTOMDIR}/bin/mflow .; cp ${PHANTOMDIR}/bin/ev2mdotbinary .; cp ${PHANTOMDIR}/bin/lombperiod .'
echo 'ev2mdot:'
echo '	cd ${PHANTOMDIR}; make '$makeflags' ev2mdot; cd -; cp ${PHANTOMDIR}/bin/ev2mdot .'
echo 'ev2mdotsink:'
echo '	cd ${PHANTOMDIR}; make '$makeflags' ev2mdotsink; cd -; cp ${PHANTOMDIR}/bin/ev2mdotsink .'
echo 'ev2mdotbinary:'
echo '	cd ${PHANTOMDIR}; make '$makeflags' ev2mdotbinary; cd -; cp ${PHANTOMDIR}/bin/ev2mdotbinary .'
echo 'make:'
