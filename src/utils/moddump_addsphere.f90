...
subroutine modify_dump(npart,npartoftype,massoftype,xyzh,vxyzu)
 ...
 use part,              only:igas,xyzmh_ptmass
 ...
 real                   :: totmass,psep,hfact,totmass_sphere,r_sphere,pmass,vphi,star_m,x_sphere
 real    :: xp(3), vp(3)
...
if (in_disk==1) then
 ...
 do i = 1,np_add
    ! Add the particle
    ipart = ipart + 1
    call  add_or_update_particle(igas, xyzh_add(1:3,i), vp, xyzh_add(4,i), &
