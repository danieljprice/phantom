...
subroutine modify_dump(npart,npartoftype,massoftype,xyzh,vxyzu)
 use part,              only:nptmass,xyzmh_ptmass,vxyz_ptmass,ihsoft,ihacc,iJ2,iReff!,igas,ihacc,ihsoft
 ...
 xyzmh_ptmass(ihacc,nptmass)     = 0. ! accretion radius - to avoid "dead" particles
 xyzmh_ptmass(ihsoft,nptmass)     = rsink ! use softening length as Rstar
 xyzmh_ptmass(iJ2,nptmass)     = 0. ! just to be safe
 xyzmh_ptmass(iReff,nptmass)     = 0. ! just to be safe
