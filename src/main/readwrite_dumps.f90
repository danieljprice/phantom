...
<<<<<<< HEAD:src/main/readwrite_dumps_fortran.f90
...
>>>>>>> upstream/master:src/main/readwrite_dumps.f90
...
>>>>>>> upstream/master:src/main/readwrite_dumps.f90
 ...
 call check_arrays(i1,i2,noffset,npartoftype,npartread,nptmass,nsinkproperties,massoftype,&
                     ...
                     got_radprop,got_Tdust,got_eosvars,got_nucleation,got_iorig,got_iseed_sink,  &
                     got_apr_level,iphase,xyzh,vxyzu,pxyzu,alphaind,xyzmh_ptmass,Bevol,iorig,iseed_sink,iprint,ierr)
