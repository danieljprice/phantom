module utils_sdar
 implicit none
 real, dimension(8),parameter :: ck=(/0.3922568052387800,0.5100434119184585,-0.4710533854097566,&
 ...
 real, dimension(8),parameter :: dk=(/0.7845136104775600,0.2355732133593570,-1.1776799841788701,&
