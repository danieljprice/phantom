...
subroutine inject_particles(time,dtlast,xyzh,vxyzu,xyzmh_ptmass,vxyz_ptmass,&
 ...
 use part,      only:igas,hfact,massoftype,kill_particle,shuffle_part
 ...
 if (xyzmh_ptmass(6,1) > 0.) then
   nbounce=0
   print*,'before xyz:',xyzh(1:3,1)
   print*,'before vxyz:',vxyzu(1:3,1)
   ! 'bounce' gas off sink particle
   star_xyz = xyzmh_ptmass(1:3,1)
   star_r = xyzmh_ptmass(6,1)
   ...
   enddo
   print*,'after xyz:',xyzh(1:3,1)
   print*,'after vxyz:',vxyzu(1:3,1)
