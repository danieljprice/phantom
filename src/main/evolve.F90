...
!
 ...
 fxyz_ptmass_sinksink,ntot,poten,ndustsmall,accrete_particles_outside_sphere,tmunus,dens,metrics,metricderivs
 ...
 implicit none
 public :: evol, evol_init, evol_step
...
end subroutine evol_step

subroutine finalize_step
