...
!    31 = Barotropic + locally isothermal disc centered on a sink particle
!
! :References: None
!
! :Owner: Daniel Price
...
!
! :Dependencies: dim, eos_barotropic, eos_barotropic_iso, eos_gasradrec, eos_helmholtz,
!   eos_idealplusrad, eos_mesa, eos_piecewise, eos_shen, infile_utils, io,
!   ionization_mod, mesa_microphysics, part, physcon, units
!
 implicit none
 integer, parameter, public :: maxeos = 40
 real,               public :: polyk, polyk2, gamma
 real,               public :: polyk_iso ! polyk_constant for isothermal part of barotropic
...
subroutine read_options_eos(name,valstring,imatch,igotall,ierr)
 ...
 if (.not.imatch .and. ieos==31) call read_options_eos_barotropic_iso(name,valstring,imatch,igotall_barotropic,ierr)
