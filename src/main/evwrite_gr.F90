...
module evwrite
 ...
 use energies,       only: track_mass,track_lum
...
subroutine init_evfile(iunit,evfile)
 ...
 use dim,       only: maxtypes,maxalpha,maxp,lightcurve
...
subroutine write_evlog(iprint)
 use dim,       only:maxp,maxalpha,mhd,maxvxyzu,periodic
 use energies,  only:ekin,etherm,emag,epot,etot,rmsmach,vrms,accretedmass
