...
!                                 timei,fextxi,fextyi,fextzi,poti,dtf,i)  !????? VELOCITY and other quantities ?
!              dtextforcenew = min(dtextforcenew,C_force*dtf)
!
!              fextx = fextx + fextxi
!              fexty = fexty + fextyi
...
!                      fxi,fyi,fzi,fextv,dt,xyzh(1,i),xyzh(2,i),xyzh(3,i),dens(i),vxyzu(4,i))
!                 fextx = fextx + fextv(1)
!                 fexty = fexty + fextv(2)
!                 fextz = fextz + fextv(3)
!              endif
