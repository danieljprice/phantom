...
subroutine read_options_spiral(db,nerr)
 ...
 call read_inopt(LMabar,'a_bar',db,errcount=nerr,min=0.)
 call read_inopt(LMbbar,'b_bar',db,errcount=nerr,min=0.)
 call read_inopt(LMcbar,'c_bar',db,errcount=nerr,min=0.)
 call read_inopt(alpha,'pitchA',db,errcount=nerr,min=0.)
 call read_inopt(NN,'NN',db,errcount=nerr,min=0.)
 call read_inopt(phibar,'phib',db,errcount=nerr,min=0.)
 call read_inopt(phir,'phir',db,errcount=nerr,min=0.)
